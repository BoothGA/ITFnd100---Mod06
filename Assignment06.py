...
# GBooth,2.18.2023Modified code to complete assignment 06
# ---------------------------------------------------------------------------- #
# Data ---------------------------------------------------------------------- #
...
class IO:
    ...
    def output_current_tasks_in_list(list_of_rows):
        ...
        :return: nothing
        """
        print("\n******* The current tasks To Do are: *******".title())
        for row in list_of_rows:
    ...
    def input_new_task_and_priority():
        ...
        priority = input("What is the priority of this task? (Low | High)\n").strip()
...
while (True):
    ...
    if choice_str.strip() == '1':  # Add a new Task
        ...
        strEnd = input("Are you sure you want to end program? (Y or N)")
        if str(strEnd).lower() == "y":
            break
print("\nGoodbye!")
